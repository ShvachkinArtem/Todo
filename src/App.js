...
const App = () => {
  ...
  function addTodo() {
    setTodos(prev => [...prev, { id: newId, completed: false, title: newTitle ,createdAt:new Date().getTime() }])
  }
 ...
 setTodos(newTodos)
  ...
  return (
    <div>
      ...
      <ToDoList todos={todos} onToggle={toggleTodo} deleteTask={deleteTask} changeTitle={changeTitle}></ToDoList>
